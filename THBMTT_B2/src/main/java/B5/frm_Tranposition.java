 ...
 */
public class frm_Tranposition extends javax.swing.JFrame {
    private TranspositionCipher transpositionCipher;
    /**
     * Creates new form frm_Tranposition
     */
    public frm_Tranposition() {
        initComponents();
    }
    ...
    private void btnMaHoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMaHoaActionPerformed
        ...
        String keyStr = txtFKey.getText();

        if (!plaintext.isEmpty() && !keyStr.isEmpty()) {
            // Chuyển đổi key từ chuỗi thành mảng số nguyên
            int[] key = Arrays.stream(keyStr.split(","))
                    .mapToInt(Integer::parseInt)
                    .toArray();

            // Tạo đối tượng TranspositionCipher
            transpositionCipher = new TranspositionCipher();

            // Mã hóa văn bản plaintext
            ...
            // Cập nhật JTextArea với ciphertext
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_Tranposition.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_Tranposition().setVisible(true);
            }
        });
    }
