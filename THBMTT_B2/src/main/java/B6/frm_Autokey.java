...
//        }
        try {
            ...
            AutokeyCipher tc = new AutokeyCipher(key);
            String ciphertext = tc.encrypt(plaintext);
...
//        // Lấy ciphertext và key từ các TextField
//        String ciphertext = txtABanMa.getText();
//        String key = txtFKey.getText();
//
//        // Kiểm tra xem ciphertext và key có rỗng không
//        if (!ciphertext.isEmpty() && !key.isEmpty()) {
//            // Tạo đối tượng AutokeyCipher và giải mã ciphertext
//            String plaintext = autokeyCipher.decrypt(ciphertext, key);
//
//            // Hiển thị thông báo thành công
//            JOptionPane.showMessageDialog(this, "Decrypted successfully.");
//
//            // Hiển thị plaintext trong TextField
//            txtABanRo.setText(plaintext);
//        } else {
//            // Hiển thị thông báo nếu ciphertext hoặc key bị rỗng
...
//        }
        ...
        try {
            ...
            String plaintext = tc.decrypt(ciphertext);
