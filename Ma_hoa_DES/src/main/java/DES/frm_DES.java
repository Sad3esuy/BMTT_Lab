...
public class frm_DES extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MA HOA DES DEMO");
    ...
    private void btnMaHoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMaHoaActionPerformed
        try {
            ...
            String secretKey = txtFKey.getText();  // Sửa tên biến 'txt key' thành 'txt_key'
            String encryptedText = DESCipher.encrypt(plaintext, secretKey);  // Sửa 'secretkey' thành 'secretKey'
            txtABanMa.setText(encryptedText);
        } catch (Exception e) {
            // Sửa câu lệnh trong JOptionPane để hiển thị thông báo lỗi đúng cách
    ...
    private void btnGiaiMaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGiaiMaActionPerformed
        try {
            String ciphertext = txtABanMa.getText();  // Sửa lỗi thiếu dấu "=" và thiếu dấu ";".
            String secretKey = txtFKey.getText();  // Sửa lỗi tên biến 'txt key' thành 'txt_key'.
            String decryptedText = DESCipher.decrypt(ciphertext, secretKey);  // Sửa lỗi cú pháp.
            txtABanRo.setText(decryptedText);  // Cập nhật lại giao diện người dùng với văn bản đã giải mã.
        } catch (Exception e) {
            // Hiển thị thông báo lỗi đúng cách
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
