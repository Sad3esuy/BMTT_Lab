...
public class AESCipher {
    ...
    private static final String ENCRYPTION_KEY = "encryptionKey";  // Khóa sử dụng cho AES (16 bytes)
    ...
    // Phương thức sinh khóa từ secretKey
    private static SecretKey generateKey(String secretKey) throws NoSuchAlgorithmException {
        ...
        if (keyBytes.length < 16) {
            ...
            // Nếu khóa dài hơn 16 byte, chỉ lấy 16 byte đầu tiên
